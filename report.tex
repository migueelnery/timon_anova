...
Para o cálculo dos componentes de variância é utilizado o procedimento ANOVA. A Tabela \ref{tab:with_interaction} exibe os graus de liberdade (Df), soma dos quadrados (Sum Sq), média dos quadrados (Mean Sq), valor da distribuiçao F, e o P-valor para cada uma das fontes.
\begin{table}[H]
